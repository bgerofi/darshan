    ...
    char *mnt_pt, char *fs_type, struct lustre_record_ref *lustre_rec_ref)
{
    ...
    for (i = 0; i < write_count; i++) {
		...
		if(offset == -1 && length == -1){
			printf("%8s%8" PRId64 "%7s%9d%16" PRId64 "%16" PRId64 "%12.4f%12.4f", "X_POSIX", rank, "opendir", i, offset, length, start_time, end_time);
		}else if (offset == -2 && length == -2){
			printf("%8s%8" PRId64 "%7s%9d%16" PRId64 "%16" PRId64 "%12.4f%12.4f", "X_POSIX", rank, "closedir", i, offset, length, start_time, end_time);
		}else if (offset == -3 && length == -3){
			printf("%8s%8" PRId64 "%7s%9d%16" PRId64 "%16" PRId64 "%12.4f%12.4f", "X_POSIX", rank, "readdir", i, offset, length, start_time, end_time);
		}else if (offset == -4 && length == -4){
			printf("%8s%8" PRId64 "%7s%9d%16" PRId64 "%16" PRId64 "%12.4f%12.4f", "X_POSIX", rank, "fdopendir", i, offset, length, start_time, end_time);
		}else if (offset == -5 && length == -5){
			printf("%8s%8" PRId64 "%7s%9d%16" PRId64 "%16" PRId64 "%12.4f%12.4f", "X_POSIX", rank, "open", i, offset, length, start_time, end_time);
		}else if (offset == -6 && length == -6){
			printf("%8s%8" PRId64 "%7s%9d%16" PRId64 "%16" PRId64 "%12.4f%12.4f", "X_POSIX", rank, "close", i, offset, length, start_time, end_time);
		}else{
